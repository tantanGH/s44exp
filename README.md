...
- PCM8A.X ... すべての形式がリアルタイムに内蔵ADPCMの音声に変換されて出力されます。
- PCM8PP.X ... 内蔵ADPCM形式も含めたすべての形式の音声がMercury-Unitから出力されます。

PCM8A.X / PCM8PP.X のいずれも組み込まない場合は S44EXP.X 自身による内蔵ADPCM再生となりますが、歌詞データ表示での遅れが目立つ場合がありますので、いずれかの組み込みを推奨します。
