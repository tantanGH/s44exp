...
COMMON_FLAGS="-m68000 -Os ${INCLUDE_FLAGS} -z-stack=32768 -DXDEV68K -DJPEG_SUPPORT"
...
function build_s44exp() {
  do_compile . "crtc himem picojpeg jpeg_decode bmp_decode pcm8 pcm8a pcm8pp adpcm_encode raw_decode ym2608_decode wav_decode kmd main" "ym2608_adpcmlib"
